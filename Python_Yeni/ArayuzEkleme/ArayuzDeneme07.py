#ArayuzDeneme07 oldu üzerinde değişiklik yap
import sys
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Add QLineEdit widgets for team ID, altitude, and acceleration
        ana_sistem_layout.addWidget(QLabel("Paket:"))
        ana_sistem_layout.addWidget(QLineEdit())
        ...
        yedek_sistem_layout.addWidget(QLineEdit())
        ...
        faydali_yuk_layout.addWidget(QLineEdit())
