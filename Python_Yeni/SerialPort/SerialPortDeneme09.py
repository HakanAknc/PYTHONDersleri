#Deneme07 veri alınıyor isim değişikliği yapıldı
import sys
...
class SerialPortWidget(QWidget):
    def __init__(self):
        ...
        self.baudrate_list_widget = QComboBox()
        ...
        # Baudrate listesi
        self.baudrate_list_widget.addItems(['9600', '19200', '38400', '57600', '115200'])
        ...
        baud_layout.addWidget(self.baudrate_list_widget)
...
if __name__ == '__main__':
    ...
    app.setApplicationName("Bozdoğan Roket")
