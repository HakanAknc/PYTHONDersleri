#Arayuzun ilk hali bunun üzerinde değişiklik yap
import sys
...
#İstenenler:
#Arayüzde anasınıf penceresinde birinci widgeti kaldır ArayuzDeneme12 dosyasını ekle
#Arayüzde portseç kısmında veri alan ve veri gönderen kısımlarını ekle