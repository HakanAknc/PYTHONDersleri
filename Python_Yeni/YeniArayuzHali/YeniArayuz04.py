...
class MainWindow(QMainWindow):
    ...
    def update_values(self):
        ...
        ana_sistem_paket = round(random.uniform(0, 10))
        ana_sistem_ivme = round(random.uniform(0, 5))
        ana_sistem_irtifa = round(random.uniform(0, 500))
        ana_sistem_sicaklik = round(random.uniform(-50, 50))
        ana_sistem_nem = round(random.uniform(0, 100))
        ana_sistem_eğim = round(random.uniform(10, 50))
        ana_sistem_enlem = round(random.uniform(10, 50))
        ana_sistem_boylam = round(random.uniform(10, 100))
        ana_sistem_takim_id = round(random.uniform(10, 100))
        ana_sistem_atesleme_durumu = round(random.uniform(10, 100))
        ana_sistem_saat = round(random.uniform(10, 100))
        ana_sistem_pil_sicaklik = round(random.uniform(10, 100))
        ana_sistem_pil_yüzdesi = round(random.uniform(10, 100))


        yedek_sistem_paket = round(random.uniform(0, 10))
        yedek_sistem_ivme = round(random.uniform(0, 5))
        yedek_sistem_irtifa = round(random.uniform(0, 500))
        yedek_sistem_sicaklik = round(random.uniform(-50, 50))
        yedek_sistem_nem = round(random.uniform(0, 100))
        yedek_sistem_eğim = round(random.uniform(10, 50))
        yedek_sistem_enlem = round(random.uniform(10, 50))
        yedek_sistem_boylam = round(random.uniform(10, 100))
        yedek_sistem_takim_id = round(random.uniform(10, 100))
        yedek_sistem_atesleme_durumu = round(random.uniform(10, 100))
        yedek_sistem_saat = round(random.uniform(10, 100))
        yedek_sistem_pil_sicaklik = round(random.uniform(10, 100))
        yedek_sistem_pil_yüzdesi = round(random.uniform(10, 100))


        faydali_yuk_paket = round(random.uniform(0, 10))
        faydali_yuk_ivme = round(random.uniform(0, 5))
        faydali_yuk_irtifa = round(random.uniform(0, 500))
        faydali_yuk_sicaklik = round(random.uniform(-50, 50))
        faydali_yuk_nem = round(random.uniform(0, 100))
        faydali_yük_eğim = round(random.uniform(10, 50))
        faydali_yük_enlem = round(random.uniform(10, 50))
        faydali_yük_boylam = round(random.uniform(10, 100))
        faydali_yük_takim_id = round(random.uniform(10, 100))
        faydali_yük_atesleme_durumu = round(random.uniform(10, 100))
        faydali_yük_saat = round(random.uniform(10, 100))
        faydali_yük_pil_sicaklik = round(random.uniform(10, 100))
        faydali_yük_pil_yüzdesi = round(random.uniform(10, 100))
